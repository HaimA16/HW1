...
public class Dog extends TerrestrialAnimals{
    ...
    public Dog(String name, Gender gender, double weight, double speed, Medal[] medals, java.awt.Point location, Orientation orientation, int size, int id, int maxEnergy, int energyPerMeter, CompetitionPanel pan, BufferedImage img1, int noLegs, String breed){
        super();
        this.breed = null;
    }
