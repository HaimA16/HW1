...
public abstract class TerrestrialAnimals extends Animal {
     ...
     *
     * @return the category of the animal, which is "Terrestrial"
     */
    ...
    /**
     * Loads images for the terrestrial animal.
     * The images are loaded from a specified directory and are associated with different orientations.
     *
     * @param nm the name of the animal, used to construct the file names for the images
     */
    @Override
    public void loadImages(String nm) {
        try {
            setImg1(ImageIO.read(new File(PICTURE_PATH + File.separator + nm + "E.jpg"))); // Image facing east
            setImg2(ImageIO.read(new File(PICTURE_PATH + File.separator + nm + "S.jpg"))); // Image facing south
            setImg3(ImageIO.read(new File(PICTURE_PATH + File.separator + nm + "W.jpg"))); // Image facing west
            setImg4(ImageIO.read(new File(PICTURE_PATH + File.separator + nm + "N.jpg"))); // Image facing north
